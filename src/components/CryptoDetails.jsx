...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    // { title: '24h Volume', value: `$ ${ cryptoDetails.24hVolume && millify(cryptoDetails.volume)}`, icon: <ThunderboltOutlined /> },
      ...
      <Col className='coin-detail-container'>
          ...
          <Col className='coin-desc-link'>
              <Row className='coin-desc'>
                  <Title level={3} className='coin-details-heading' style={{color: "black"}}>
